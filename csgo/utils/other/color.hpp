...
struct color_t
{
    ...
    constexpr color_t() : red(0), green(0), blue(0), alpha(255) { }

    constexpr color_t(int r, int g, int b, int a = 255)
        : red{ r }, green{ g }, blue{ b }, alpha{ a } { }

    uint32_t to_d3d( ) const {
    ...
    {
        return color_t(red, green, blue, a);
    }
    ...
    constexpr color_t& FromHSV(float h, float s, float v)
    {
        float colOut[3]{ };
        if (s == 0.0f)
        {
	...
	static constexpr color_t Nigger(int a = 255) { return { 0, 0, 0, a }; }
