...
void render::create_fonts( ) {
	create_font( ( void** ) & fonts::main_font, "Tahoma", 10, FW_NORMAL );
}
...
void render::filled_rect( int x, int y, int width, int height, std::uint32_t color ) {
	vtx_t vert[ 4 ] = {
...
void render::gradient_rect( int x, int y, int width, int height, std::uint32_t color1, std::uint32_t color2, bool is_horizontal ) {
...
void render::rect( int x, int y, int width, int height, std::uint32_t color ) {
	filled_rect( x, y, width, 1, color );
	filled_rect( x, y + height, width, 1, color );
	filled_rect( x, y, 1, height, color );
	filled_rect( x + width, y, 1, height + 1, color );
}
