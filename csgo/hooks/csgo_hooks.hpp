...
#include "..\utils\interfaces\sdk_interfaces.hpp"
...
public:
	...
	static void     __fastcall  override_view(void* ecx, void* edx, CViewSetup* pSetup);
	static void     __fastcall  draw_model_execute(void* ecx, void* edx, IMatRenderContext* context, const DrawModelState_t& state, const ModelRenderInfo_t& render_info, matrix3x4_t* matrix);
	...
	static void     __fastcall  scene_end(void *ecx, void *edx);
	static void     __stdcall   end_scene( IDirect3DDevice9* pDevice );
	static void     __stdcall   end_scene_reset( IDirect3DDevice9* pDevice, D3DPRESENT_PARAMETERS* pPresentationParameters );
...
private:
	...
	typedef void (__fastcall* override_view_t ) (void*, void*, CViewSetup*);
	typedef void (__thiscall* draw_model_execute_t) (void*, IMatRenderContext*, const DrawModelState_t&, const ModelRenderInfo_t&, matrix3x4_t*);
	...
	typedef void( __stdcall* end_scene_fn )(IDirect3DDevice9* device);
	typedef void( __stdcall* end_scene_reset_fn )(IDirect3DDevice9* pDevice, D3DPRESENT_PARAMETERS* pPresentationParameters);
private:
     // CSGO window handle
...
public:
	...
	HRESULT hook_function(const std::size_t index, void* fnNew)
	{
	...
	HRESULT unhook_function(const std::size_t index)
	{
